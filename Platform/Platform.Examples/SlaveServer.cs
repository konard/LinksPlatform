...
{
    /// <summary>
    /// Slave (Mirror) Server implementation that operates entirely in memory.
    /// Unlike MasterServer, this server uses no file-based persistence, keeping all data in RAM.
    /// </summary>
    public class SlaveServer
    {
        ...
        public SlaveServer(ILinks<ulong> links, Sequences sequences, UdpSender sender)
        {
            _links = links;
