...
namespace Platform.Experiments.SupervisedCodeGeneration
{
    /// <summary>
    ...
    /// <summary>
    /// Example demonstrating supervised dynamic code generation
    /// </summary>
    public class SupervisedCodeGenerationExample
    {
